        ...
        <div className="About-content">
          ...
          <div className="flex flex-[40%] justify-center items-center p-4">
              ...
              <p>I&#39;m always open to new opportunities and collaborations. If you have a project in mind 
                ...
                <div className='mt-4'>
                  <button className='downloadBTN'><a className="linked btnlinked" type="button" href="https://drive.google.com/file/d/1E0aMGCoKj6dtNwpJJ94jbAkH6DrXgN3M/view" target="_blank"><span>Download CV</span></a></button>
